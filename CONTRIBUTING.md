# Contributing to observable-decorators

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/phillipskevin/observable-decorators) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork observable-decorators, you can start by going to its [fork page](https://github.com/phillipskevin/observable-decorators/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/observable-decorators
```
